...
- create-vite ile React projesi oluşturun: `npm init --yes vite@latest me -- --template=react  --no-rolldown --no-immediate`..
- `vite.config.js` dosyası bağlantı noktasıyla güncelleştiriliyor.
- Proje dosyasını (`me.esproj`) oluşturun.
